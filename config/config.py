...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/architokxD/AnonXMusic")
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/wildbotupdates")
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/wildxbotsupport")
